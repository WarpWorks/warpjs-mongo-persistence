...
describe("lib/error", () => {
    it("should export a class", () => {
        expect(WarpJSMongoPersistenceError).to.be.a('function')
            .to.have.property('name').to.equal('WarpJSMongoPersistenceError');
    });
    ...
    describe("new WarpJSMongoPersistenceError()", () => {
        ...
        it("should initialize", () => {
            ...
            expect(e).to.have.property('name').to.equal('WarpJSMongoPersistence.WarpJSMongoPersistenceError');
