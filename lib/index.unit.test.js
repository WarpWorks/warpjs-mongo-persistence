...
describe("lib/index", () => {
    ...
    beforeEach(() => {
        Persistence = testHelpers.proxyquire(require.resolve('./index'), {
            mongodb: mongoMock
        });
    });

    it("should export a class", () => {
        expect(Persistence).to.be.a('function')
            .to.have.property('name').to.equal('Persistence');
    });

    it("should accept 2 params", () => {
        expect(Persistence).to.have.lengthOf(2);
    });
    ...
    describe("Persistence()", () => {
        ...
        beforeEach(() => {
            instance = new Persistence('dummy-host', 'dbName');
        });
